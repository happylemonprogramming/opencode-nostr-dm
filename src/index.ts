...
import type { NostrDMConfig } from './types.js'
 ...
 */
function getConfig(envVars: Record<string, string>, key: string, defaultValue: string = ''): string {
